...
---------------------------------------
SELECT users.users_id,users.full_name, COUNT(like_res.user_id) AS like_count
FROM users 
INNER JOIN like_res ON users.users_id = like_res.user_id
...
---------------------------------------
SELECT users.users_id,users.full_name, COUNT(orders.user_id) AS order_count
FROM users 
...
---------------------------------------
SELECT users.users_id,users.full_name FROM users 
LEFT JOIN orders ON users.users_id = orders.user_id
LEFT JOIN like_res ON users.users_id = like_res.user_id
LEFT JOIN rate_res ON users.users_id = rate_res.user_id
